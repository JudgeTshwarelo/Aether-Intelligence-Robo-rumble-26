...
```text
Instead of relying on fragmented information like phone calls and estimates, we provides a continuously updated 
representation of the emergency environment so that decision-makers can understand:
...
```text
In most South African rural and geographically dispersed communities, an emergency may become more 
dangerous because the appropriate responder does not know:
